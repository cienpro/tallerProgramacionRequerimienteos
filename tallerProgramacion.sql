...
--
-- Servidor: localhost
-- Tiempo de generación: 05-12-2017 a las 03:06:32
...
--
-- Estructura de tabla para la tabla `habitacoin`
--

CREATE TABLE `habitacoin` (
  `idHotel` int(11) NOT NULL,
  `numero` int(3) NOT NULL,
  `contPersonas` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indices de la tabla `habitacoin`
--
ALTER TABLE `habitacoin`
  ADD PRIMARY KEY (`numero`,`idHotel`);
...
--
ALTER TABLE `vuelo`
  ADD PRIMARY KEY (`numero`,`idUsuario`),
  ADD KEY `idServicio` (`idServicio`);
